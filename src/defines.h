...
const std::string EXTRA_CSS
    = ".mapbank-saved { background-color: rgb( 180, 240, 180 ); color: #2e3436; }\n"
      ...
      "dropdown.ability-never-hidden > button { background-image: none; background-color: rgba(86, 180, 233, 0.38); }\n"
      "dropdown.ability-hidden-only > button { background-image: none; background-color: rgba(240, 228, 66, 0.40); }\n"
      "dropdown.ability-both > button { background-image: none; background-color: rgba(204, 121, 167, 0.38); }\n"
      ".ability-row-never-hidden { background-color: rgba(86, 180, 233, 0.30); }\n"
      ".ability-row-hidden-only { background-color: rgba(240, 228, 66, 0.35); }\n"
      ".ability-row-both { background-color: rgba(204, 121, 167, 0.30); }\n"
      ".ability-row-disabled { color: rgba(46, 52, 54, 0.65); }\n"
